...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="erpel" -DDUCKDB_OOT_EXTENSION_ERPEL_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_ERPEL_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_ERPEL_INCLUDE_PATH="$(PROJ_DIR)src/include"
