...
namespace duckdb 
{
    ...
    const vector<RfcAuthParamDefinition> &RfcAuthParamDefinitions()
    {
        ...
        static const vector<RfcAuthParamDefinition> definitions = {
            ...
            {"wshost",          &RfcAuthParams::wshost,          false},
            {"wsport",          &RfcAuthParams::wsport,          false},
            {"use_tls",         &RfcAuthParams::use_tls,         false},
            {"tls_client_pse",  &RfcAuthParams::tls_client_pse,  false},
            {"tls_trust_all",   &RfcAuthParams::tls_trust_all,   false},
            {"alias_user",      &RfcAuthParams::alias_user,      false},
            {"ws_client_cert",  &RfcAuthParams::ws_client_cert,  false},
            {"ws_client_key",   &RfcAuthParams::ws_client_key,   false},
